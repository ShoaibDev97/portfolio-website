...
const Packages = () => {
    return (
        <div className="dizme_tm_section" id="packages">
            <div className="dizme_tm_services">
                <div className="container">
                    <div className="dizme_tm_main_title" data-align="center">
                        <span>Packages</span>
                        <h3>These are some of My Packages</h3>
                        <p>Most common methods for designing websites that work well on desktop is responsive and adaptive design</p>
                    </div>
                    <div className="service_list">
                        <ul>
                            {PACKAGE_CONFIG.map(({ Title, Price, Description, Thumbnail, AdditionalClass, Delay }) => {
                                return (
                                    <Package key={Title} Title={Title} Price={Price} Description={Description} Thumbnail={Thumbnail} AdditionalClass={AdditionalClass} Delay={Delay} />
                                )
                            })}
                            {/* <li className="wow fadeInLeft" data-wow-duration="1s">
                                <div className="list_inner tilt-effect">
                                    <span className="icon">
                                        ...
                                        <img className="back" src="img/brushes/service/dark/1.png" alt="" />
                                    </span>
                                    <div className="title">
                                        <h3>Creative Design</h3>
                                        <span className="price">Starts from <span className="orangeText">$99</span></span>
                                    </div>
                                    <div className="text">
                            ...
                            <li className="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div className="list_inner tilt-effect">
                                    <span className="icon">
                                        ...
                                        <img className="back" src="img/brushes/service/dark/2.png" alt="" />
                                    </span>
                                    <div className="title">
                                        <h3>Graphic Design</h3>
                                        <span className="price">Starts from <span className="orangeText">$199</span></span>
                                    </div>
                                    <div className="text">
                                        <p>Web design refers to the design of websites that are displayed on the internet. It usually refers to the user experience aspects of website development</p>
                                    </div>
                                    <a className="dizme_tm_full_link" href="#"></a>
                                    <img className="popup_service_image" src="img/service/2.jpg" alt="" />
                                    <div className="service_hidden_details">
                                        <div className="service_popup_informations">
                                            <div className="descriptions">
                                                <p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                            ...
                            <li className="wow fadeInLeft" data-wow-duration="1s">
                                <div className="list_inner tilt-effect">
                                    <span className="icon">
                                        ...
                                        <img className="back" src="img/brushes/service/dark/3.png" alt="" />
                                    </span>
                                    <div className="title">
                                        <h3>UI/UX Design</h3>
                                        <span className="price">Starts from <span className="orangeText">$299</span></span>
                                    </div>
                                    <div className="text">
                                        <p>Web design refers to the design of websites that are displayed on the internet. It usually refers to the user experience aspects of website development</p>
                                    </div>
                                    <a className="dizme_tm_full_link" href="#"></a>
                                    <img className="popup_service_image" src="img/service/3.jpg" alt="" />
                                    <div className="service_hidden_details">
                                        <div className="service_popup_informations">
                                            <div className="descriptions">
                                                <p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                            ...
                            <li className="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div className="list_inner tilt-effect">
                                    <span className="icon">
                                        ...
                                        <img className="back" src="img/brushes/service/dark/4.png" alt="" />
                                    </span>
                                    <div className="title">
                                        <h3>Web Design</h3>
                                        <span className="price">Starts from <span className="orangeText">$399</span></span>
                                    </div>
                                    <div className="text">
                                        <p>Web design refers to the design of websites that are displayed on the internet. It usually refers to the user experience aspects of website development</p>
                                    </div>
                                    <a className="dizme_tm_full_link" href="#"></a>
                                    <img className="popup_service_image" src="img/service/4.jpg" alt="" />
                                    <div className="service_hidden_details">
                                        <div className="service_popup_informations">
                                            <div className="descriptions">
                                                <p>Dizme is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                ...
                <div className="brush_1 wow fadeInLeft" data-wow-duration="1s"><img src="img/brushes/service/5.png" alt="" /></div>
                <div className="brush_2 wow zoomIn" data-wow-duration="1s"><img src="img/brushes/service/6.png" alt="" /></div>
            </div>
        </div>
    )
}
